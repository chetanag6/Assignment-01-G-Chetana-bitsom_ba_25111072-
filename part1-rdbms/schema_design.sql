-- Schema Design for 3NF Normalization

 1. Customers Table (Contains unique customer information)
...
-- 2. Products Table (Eliminates redundant product info and allows for multiple categories)
...
-- 3. SalesReps Table (Separates sales representative details from orders)
...
-- 4. Orders Table (Header information for the transaction)
CREATE TABLE Orders (
...
-- 5. OrderItems Table (Details of products in each order, eliminates repeating groups)
